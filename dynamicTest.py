...
def main():
    ...
    csv_path = 'hand_landmarks_test.csv'
    with open(csv_path, 'a', newline="") as csv_file:
        ...
        while True:
            ...
            if not ret:
                break
            """image_rgb = cv.flip(image_rgb, 1)  # Mirror display
                ...
                if results.multi_hand_landmarks is not None:
                    for hand_landmarks, handedness in zip(results.multi_hand_landmarks,
                        ...
                        if mode == 1 and sign != -1:
                            csv_writer.writerow([sign, *pre_processed_landmark_list])
                            counter += 1
                            if counter == 10:
                                sign = -1
                                letter += 1
...
def logging_csv(number, mode, landmark_list, point_history_list):
    ...
    if mode == 1 and (0 <= number <= 34):
        csv_path = 'model/keypoint_classifier/test.csv'
